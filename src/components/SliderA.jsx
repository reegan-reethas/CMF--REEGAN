...
const SliderA = ({ sliderCategoryA }) => {
  const [currentIndex, setCurrentIndex] = useState(0);
  const sliderBG = sliderCategoryA[currentIndex].backgroundColor;
  const sliderTitle = sliderCategoryA[currentIndex].heading;
  ...
  const nextSlide = () => {
    const isLastSlide = currentIndex === sliderCategoryA.length - 1;
